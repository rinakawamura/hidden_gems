...
# Locations
loc1 = Location.create(name: "Shakespear and Company", country_id: Country.find_by(name: "France").id, description: "The perfect bookstore and cafe to enjoy a good cup of coffee. ", user_id: user2.id, image_url: "http://images.faena.com/wp-content/uploads/sites/4/2017/08/shakespeare-and-co.jpg?_ga=2.135089393.1500810842.1562253848-215521494.1562253848")
...
loc3 = Location.create(name: "Burgermeister", country_id: Country.find_by(name: "Germany").id, description: "Berlin's favorite local burger joint.", user_id: user3.id, image_url: "https://dynaimage.cdn.cnn.com/cnn/q_auto,w_496,c_fill,g_auto,h_279,ar_16:9/http%3A%2F%2Fcdn.cnn.com%2Fcnnnext%2Fdam%2Fassets%2F180718111756-05-berlin-restaurants---burgermeister-schlesisches-tor.jpg")
...
loc5 = Location.create(name: "Non Nuoc Village", country_id: Country.find_by(name: "Vietnam").id, description: "A quiet village close to the central city of Da Nang.", user_id: user4.id, image_url: "https://vi-pullzone-juw0eep8zpvcctq.netdna-ssl.com/wp-content/uploads/2018/03/Non-Nuoc-stone-carving-village.jpg")
