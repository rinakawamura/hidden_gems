...
loc6 = Location.create(name: "Dine In The Dark", country_id: Country.find_by(name: "Malaysia").id, description: "The most unique dining experience in Malaysia.", user_id: user2.id, image_url: "https://dininginthedarkkl.com/wp-content/uploads/did-feature-001-min-300x200.jpg")
loc7 = Location.create(name: "Hoheikyo Hot Spring", country_id: Country.find_by(name: "Japan").id, description: "The perfect place to kick back and relax.", user_id: user1.id, image_url: "https://jozankei.jp/wp-content/uploads/2015/12/231.jpg")
loc8 = Location.create(name: "Nha Trang Noodle House", country_id: Country.find_by(name: "United States").id, description: "A taste of authentic Vietnamese cuisine.", user_id: user3.id, image_url: "http://1.bp.blogspot.com/-JhMpFAvLTFc/VaivV4jFydI/AAAAAAAAAbg/hVNmBye8-nI/s640/20150716_190823.jpg")
loc9 = Location.create(name: "Trader Sam's", country_id: Country.find_by(name: "United States").id, description: "A fun tiki bar in San Francisco.", user_id: user4.id, image_url: "http://blog.tebeau.com/wp-content/uploads/2016/02/tradrsams-sf-20130301-338.jpg")
loc10 = Location.create(name: "Kaiping", country_id: Country.find_by(name: "China").id, description: "A city with unique architecture and food in China.", user_id: user5.id, image_url: "https://unborderedlife.com/wp-content/uploads/2019/02/kaiping_diaolou_zili_roofview-830x553.jpg")
