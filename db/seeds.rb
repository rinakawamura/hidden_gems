...
# Locations
loc1 = Location.create(name: "This Restaurant", country_id: Country.find_by(name: "France").id, description: "A restaurant.", user_id: user5.id)
loc2 = Location.create(name: "This Park", country_id: Country.find_by(name: "France").id, description: "A park.", user_id: user1.id)
loc3 = Location.create(name: "This Museum", country_id: Country.find_by(name: "Germany").id, description: "A museum.", user_id: user3.id)
loc4 = Location.create(name: "This Cafe", country_id: Country.find_by(name: "United States").id, description: "A cafe.", user_id: user1.id)
loc5 = Location.create(name: "This Bridge", country_id: Country.find_by(name: "Vietnam").id, description: "A bridge.", user_id: user4.id)
